...
* @param is_block 设置接口是否为阻塞接口，TRUE 为阻塞接口 FALSE 为非阻塞接口
* @param speed 机器人直线运动速度，单位：mm/s
* @param acc 机器人直线运动角加速度,单位mm/s^2
...
* @return ERR_SUCC 成功 其他失败
*/
	errno_t set_admit_ctrl_config(const JKHD* handle, int axis, int opt, int ftUser, int ftConstant, int ftNnormalTrack, int ftReboundFK);
